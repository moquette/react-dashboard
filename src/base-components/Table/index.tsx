...
Table.Thead = function ({ className, ...props }: TheadProps) {
  return (
...
Table.Tbody = function ({ className, ...props }: TbodyProps) {
  return <thead className={className}>{props.children}</thead>
}

type TrProps = React.PropsWithChildren & React.ComponentPropsWithoutRef<'tr'>

Table.Tr = function ({ className, ...props }: TrProps) {
...
Table.Th = function ({ className, ...props }: ThProps) {
  const table = useContext(tableContext)
...
Table.Td = function ({ className, ...props }: TdProps) {
  const table = useContext(tableContext)
  return (
    <td
      className={twMerge([
