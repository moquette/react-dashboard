          ...
          <PreviewComponent className="mt-5 intro-y box">
            {({ toggle }) => (
              <>
                ...
                <div className="p-5">
                  <Preview>
                    <div className="w-full border-t border-dashed border-slate-200/60 dark:border-darkmode-400" />
                    <div className="w-full mt-5 border-t border-slate-200/60 dark:border-darkmode-400" />
                  </Preview>
                  <Source>
                    <Highlight>
                      {`
