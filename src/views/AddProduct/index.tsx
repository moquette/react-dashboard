          ...
          {({ dismiss }) => (
            <div className="flex items-center">
              ...
              <span>
                ...
                the Seller.
                <a href="/" className="ml-1 underline" target="blank">
                  Learn More
                </a>
              </span>
              <Alert.DismissButton
                  ...
                  <div className="flex-1 w-full mt-3 xl:mt-0">
                    <div className="overflow-x-auto">
                      <Table className="border">
                        <Table.Thead>
                          <Table.Tr>
                            <Table.Th className="!pr-2 bg-slate-50 dark:bg-darkmode-800" />
                            <Table.Th className="bg-slate-50 dark:bg-darkmode-800" />
                            ...
                            <Table.Th className="!px-2 bg-slate-50 dark:bg-darkmode-800" />
                          </Table.Tr>
                        </Table.Thead>
                        <Table.Tbody>
                          <Table.Tr>
                      ...
                      {({ dismiss }) => (
                        <div className="flex items-center">
                          ...
                          <span className="text-slate-800 dark:text-slate-500">
                            Pay close attention to the weight of the product so
                            that there is no difference in data with the
                            shipping courier.{' '}
