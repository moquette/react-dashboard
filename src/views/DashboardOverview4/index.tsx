          ...
          <div className="col-span-12 mt-8 xl:col-span-9">
            <div className="flex items-center h-10 intro-y">
              <h2 className="mr-5 text-lg font-medium truncate">
                General Report <span className="font-light">(overview 4)</span>
              </h2>
              ...
              <div className="flex items-center mb-5">
                <div className="flex items-center">
                  ...
                  <Tippy
                    ...
                    content="49% Higher than last month"
                  >
                    -2% <Lucide icon="ChevronDown" className="w-4 h-4 ml-0.5" />
                  </Tippy>
                </div>
              ...
              <div className="flex items-center mb-5">
                <div className="flex items-center">
                  ...
                  <Tippy
                    ...
                    content="49% Higher than last month"
                  >
                    -9% <Lucide icon="ChevronDown" className="w-4 h-4 ml-0.5" />
                  </Tippy>
                </div>
