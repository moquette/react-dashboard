      ...
      <div className="col-span-12 lg:col-span-3 2xl:col-span-2">
        ...
        <div className="p-5 mt-6 intro-y box">
          ...
          <div className="pt-4 mt-4 border-t border-slate-200 dark:border-darkmode-400">
            ...
            <a href="/" className="flex items-center px-3 py-2 mt-2 rounded-md">
              <div className="w-2 h-2 mr-3 rounded-full bg-success" />
              Important Meetings
            </a>
            <a href="/" className="flex items-center px-3 py-2 mt-2 rounded-md">
            ...
            <a href="/" className="flex items-center px-3 py-2 mt-2 rounded-md">
              <div className="w-2 h-2 mr-3 rounded-full bg-danger" />
              Next Week
            </a>
            <a href="/" className="flex items-center px-3 py-2 mt-2 rounded-md">
            ...
            >
              <div className="relative px-3 pt-8 pb-5 rounded-md file box sm:px-5 zoom-in">
                ...
                {(() => {
                  ...
                  if (faker.files[0].type === 'Folder')
                    return (
                      <FileIcon className="w-3/5 mx-auto" variant="directory" />
                    )
