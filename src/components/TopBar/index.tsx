...
function Main(props: {
  layout?: 'side-menu' | 'simple-menu' | 'top-menu' | 'sans-menu'
}) {
  ...
  return (
    <div
      className={clsx([
        ...
        "before:content-[''] before:absolute before:h-[65px] backdrop-blur before:inset-0 before:top-0 before:mx-7 before:bg-primary/30 before:mt-3 before:rounded-xl before:hidden before:md:block before:dark:bg-darkmode-600/30",
      ...
      <div className="flex items-center h-full">
        ...
        <Menu>
          <Menu.Button className="block w-8 h-8 overflow-hidden rounded-full shadow-lg image-fit zoom-in intro-x">
            <img alt="React Vite Dashboard" src={fakerData[9].photos[0]} />
          </Menu.Button>
          <Menu.Items className="w-56 mt-px relative bg-primary/80 before:block before:absolute before:bg-black before:inset-0 before:rounded-md before:z-[-1] text-white">
            ...
            <Menu.Divider className="bg-white/[0.08]" />
            <Menu.Item className="hover:bg-white/5">
              <Lucide icon="LogOutIcon" className="w-4 h-4 mr-2" /> Logout
            </Menu.Item>
            <Menu.Divider className="bg-white/[0.08]" />
            <Menu.Item className="hover:bg-white/5">
              <DarkModeSwitcher />
